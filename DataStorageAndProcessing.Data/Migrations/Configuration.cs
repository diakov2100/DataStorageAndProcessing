namespace DataStorageAndProcessing.Data.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<DataStorageAndProcessing.Data.Context>
    {
        public Configuration()
        {
            ...
            ContextKey = "DataStorageAndProcessing.Data.Context";
        }
        ...
        protected override void Seed(DataStorageAndProcessing.Data.Context context)
        {
            ...
            foreach (string link in SiteList)
            {
                ...
                context.Raitings.AddOrUpdate(TecRaiting);
        ...
        private void SiteParser(string link, Raiting TecRaiting, Context context)
        {
            ...
            foreach (List<string> list in table)
            {
                ...
                if (TecLoc == null)
                {
                    ...
                    context.Locations.AddOrUpdate(TecLoc);
                }
                ...
                if (TecInst == null)
                {
                    ...
                    context.Institutions.AddOrUpdate(TecInst);
                }
                ...
                context.InstiutionRaitings.AddOrUpdate(TecInstRait);
            }
        }
